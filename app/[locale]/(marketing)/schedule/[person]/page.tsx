...
import { entityFor, TYPES } from '@/lib/schedule/config'
      ...
      <section className="px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-9 grid gap-5 sm:grid-cols-2">
            {TYPES.map(t => (
              <Link key={t.slug} href={`/schedule/${person}/${t.slug}` as '/'} className="group rounded-2xl border border-gray-200 bg-white p-6 transition-all hover:-translate-y-0.5 hover:shadow-md">
