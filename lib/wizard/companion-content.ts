...
export const STEP_COMPANIONS: Record<string, StepCompanion> = {
  '01-beef-radar': {
      "key": "01-beef-radar",
      "hook": "Du verkaufst Features. Der Kunde kauft Effekte. Beef-Radar uebersetzt das eine ins andere — auf einer Karte mit fuenf Zeilen.",
      ...
      "ai": "Die AI nimmt Deine Angebots-Beschreibung + ICP + Preisspanne und schlaegt 5-9 Karten in den drei Spalten vor — mit konkreten Zahlen und Wellen-Effekten. Du editierst direkt. „Suggest More\" appendet weitere Karten, ohne Dein Eingegebenes zu ueberschreiben."
  },
  '02-doppelschmerz': {
  ...
  '04-phasen-waehrung': {
      ...
      "how": "Pro Phase aus Schritt 3 eine Hauptwaehrung. Baseline (wo der Kunde heute steht) + Drei-Punkt-Korridor (Pessimist / Realist / Optimist) + Mess-Zeitpunkt (Woche X Review). Optional 1-2 Sekundaer-Waehrungen pro Phase.",
      "ai": "Die AI nimmt die Phasen aus Schritt 3 + Deine Branchen-Baselines und schlaegt fuer jede Phase eine Hauptwaehrung mit realistischen Korridoren vor — angekoppelt an Methodik, nicht an Wunsch-Denken."
  },
  '05-beweis-stapel': {
      ...
      "why": "Beweise sind die Spur, die Dein Kunde zur Vorstandstuer mitnimmt. Ohne sie kann er Deinen Pitch nicht weitererzaehlen. Mit ihr traegt sich Dein Angebot selbst — auch wenn Du nicht im Raum bist. Plus: Mindestens 2 aus A oder B im Top-3 (kein „bis zu\"-Spielraum, sondern echte Belege).",
      ...
      "ai": "Die AI nimmt Deine Phasen + Waehrungen + Customer-Cases und baut den Stapel vor — sortiert nach Klasse, mit Methodik-Vorschlaegen fuer Hypothesen. Du editierst und ergaenzt."
  },
  '06-booster': {
      "key": "06-booster",
      ...
      "why": "Booster loesen ein angrenzendes Problem, das der Kunde im Pitch nicht erwartet hat. Echter Lieferaufwand ≤ 20 % des wahrgenommenen Werts. Bonus ist nicht „mehr fuer gleichen Preis\" — Bonus ist „zweites Problem geloest, mit €-Anker und Margin-Schutz\". Damit haeltst Du Pricing-Power stabil.",
  ...
  '07-wort-garantie': {
      ...
      "hook": "Wenn Du beim Aufschreiben Deiner Garantie zoegerst, ist die Garantie zu gross — oder Dein Pfad zu schwach. Beides ist Diagnose, kein Versagen.",
      "why": "Eine Wort-Garantie oeffnet Tueren, die Pricing nicht oeffnet. CFOs, Procurement, neue Stakeholder suchen Risiko-Reduktion. „100 % Zufriedenheits-Garantie\" ist ein Marketing-Schwur. „Wenn Phase 2 die Annahmequote nicht um 8 Punkte hebt, laeuft Phase 3 ohne Rechnung\" ist ein Verkaeufer-Versprechen — angeklemmt an Phase und Waehrung aus Schritten 3+4.",
      "how": "Typ (Refund / Office-Hours / Continuation) + Trigger-Bedingung + Konsequenz + Liefer-Anker (welche Phase und welche Waehrung tragen sie) + Espresso-Test bestanden (kannst Du sie beim Espresso aussprechen ohne Marketing-Sound?).",
      "ai": "Die AI nimmt Deine Phasen + Waehrungen + Risiko-Profil und schlaegt 1-2 Garantie-Optionen vor — kalibriert gegen den Pessimist-Korridor, damit Du sie tatsaechlich verteidigen kannst."
  },
  '08-letzten-20-prozent': {
      ...
      "how": "3 Name-Optionen mit Stil-Variation („[Substantiv] fuer [Branche]\" / „[Verb]-[Substantiv]\" / „[Adjektiv] [Substantiv]\") + Espresso-Test-Score (0-5) + Empfehlung markieren. 2-3 Headline-Optionen. 1 klarer CTA fuer den naechsten Mikro-Schritt des Kunden.",
