...
const POSITIVE_WORDS = ['wachstum','aufschwung','momentum','skalierung','hebel','durchbruch','expansion','sprung','boost','schub','zuwachs','dynamik','aufstieg','schwungrad','erfolg','triumph','sieg','gewinn','meilenstein','rekord','champion','gipfel','podium','siegeszug','bestwert','erfolgskurs','volltreffer','ergebnis','resultat','wirkung','effekt','ertrag','rendite','bilanz','abschluss','treffer','mehrwert','impact','wertbeitrag','marke','kampagne','reichweite','funnel','botschaft','story','positionierung','sichtbarkeit','resonanz','magnet','zielgruppe','kanal','hook','brand','vertrieb','pipeline','deal','akquise','lead','angebot','verhandlung','umsatz','closing','neukunde','discovery','quote','kundenwert','pitch','fuehrung','vision','strategie','klarheit','richtung','verantwortung','teamgeist','kompass','entscheidung','haltung','mut','initiative','fokus','vorbild']
