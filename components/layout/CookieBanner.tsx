    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 md:left-auto md:right-6 md:max-w-md">
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-xl">
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-gray-900">Einsatz von Cookies</span>
        </div>
        <p className="mb-3 text-xs text-gray-600 leading-relaxed">
          Wir verwenden technisch erforderliche Cookies für den Betrieb der Seite. Darüber hinaus möchten wir mit Deiner Einwilligung weitere Cookies setzen — Du entscheidest, welche.
          {' '}
        ...
        {expanded && (
          <div className="mb-4 space-y-3 rounded-xl border border-gray-100 bg-gray-50 p-3">
            <ToggleRow
              ...
              body="Erfassen Page Views, Web Vitals und Fehler in aggregierter Form. Werden über Vercel Analytics ausgewertet, ohne Profilbildung."
            />
            <ToggleRow
              checked={marketing}
              onChange={setMarketing}
              label="Marketing-Cookies"
              body="Conversion-Tracking und Retargeting für unsere Anzeigen auf LinkedIn, Meta und Google. Aktuell noch nicht aktiv — Slot bleibt vorbereitet."
            />
          </div>
        )}
          ...
          {!expanded ? (
            <>
              ...
              <button
                ...
                style={{ color: '#1A5FD4' }}
              >
                <ChevronDown size={11} /> Individuelle Auswahl
              </button>
            </>
          ) : (
            <>
